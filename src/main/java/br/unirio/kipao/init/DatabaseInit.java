...
public class DatabaseInit implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		{	
			...
			kit.setMetric("Kit");
			kit.setName("5 Pães");
			kit.setUnitPrice(new Double("10.00"));
			...
			address.setCity("Lago das Hortências");
			...
			scheduler.setOrderState("Aguardando confirmação");
